    ...
    <div class="container">
        ...
        <div class="thread-details">
            <p>
                ...
                <strong>Follow-up Plan:</strong> <?= $thread->request_follow_up_plan === Thread::REQUEST_FOLLOW_UP_PLAN_SPEEDY ? 'Simple request, expecting speedy follow up' : ($thread->request_follow_up_plan === Thread::REQUEST_FOLLOW_UP_PLAN_SLOW ? 'Complex request, expecting slow follow up' : ($thread->request_follow_up_plan === Thread::REQUEST_FOLLOW_UP_PLAN_POSTLISTE ? 'Postjournal request, automatic reminders on day 10 and 20' : 'Not specified')) ?>
            </p>
