...
class ThreadStatusRepositoryTest extends PHPUnit\Framework\TestCase {
    ...
    public function testGetAllThreadStatusesEfficient(): void {
        ...
        $this->assertEquals(array('email_count_in' => 0, 'email_count_out' => 1, 'thread_id' => $this->testThreadId, 'status' => ThreadStatusRepository::EMAIL_SENT_NOTHING_RECEIVED), $statuses[$this->testThreadId], "Status for test thread should be EMAIL_SENT_NOTHING_RECEIVED");
        $this->assertEquals(array('email_count_in' => 0, 'email_count_out' => 0, 'thread_id' => $secondThreadId, 'status' => ThreadStatusRepository::NOT_SENT), $statuses[$secondThreadId], "Status for second thread should be NOT_SENT");
    }
    ...
    public function testGetAllThreadStatusesEfficientWithThreadIdsFilter(): void {
        ...
        $this->assertEquals(array('email_count_in' => 0, 'email_count_out' => 1, 'thread_id'  => $this->testThreadId, 'status' => ThreadStatusRepository::EMAIL_SENT_NOTHING_RECEIVED), $filteredStatuses[$this->testThreadId], "Status for test thread should be EMAIL_SENT_NOTHING_RECEIVED");
        $this->assertEquals(array('email_count_in' => 0, 'email_count_out' => 0, 'thread_id' => $thirdThreadId, 'status' => ThreadStatusRepository::NOT_SENT), $filteredStatuses[$thirdThreadId], "Status for third thread should be NOT_SENT");
    }
