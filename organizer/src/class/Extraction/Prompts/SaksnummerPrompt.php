...
class SaksnummerPrompt extends OpenAiPrompt {
    ...
    public function getPromptText(): string {
        return '📧 You are a system for analyzing emails. Your task is to extract a case number only if it is **explicitly** mentioned in one of the allowed formats.'
            ...
            . "\nIf the entity is not mentioned or unclear, set entity_name to an empty string."
            . "\nIf no document number is available, set document_number to an empty string."

            . "\n\n❌ Do NOT make up any data. Only extract what is literally in the email."

            . "\n\n📧 Example input:"
            . "\n\"Dear Sir, regarding your inquiry, the case number 2025/123 has been updated.\""
            . "\n✅ Expected output:"
            . "\n```json"
            . "\n{"
            . "\n  \"found_case_number\": true,"
            ...
            . "\n\nIf no case number is found, return:"
            . "\n```json"
            . "\n{"
